...
const fizzbuzz = (arr) => {
  ...
  arr.forEach((element,index) =>{
    let mytest1 = element/3;
    let mytest2 = element/5;
    if(Number.isInteger(mytest1) && Number.isInteger(mytest2)){
      outputArr.push('Fizz Buzz');
    }else if(Number.isInteger(mytest2)){
      outputArr.push('Buzz');
    }else if(Number.isInteger(mytest1)){
      outputArr.push("Fizz");
    }else{
