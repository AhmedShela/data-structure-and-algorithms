...
const generateSubmitButton = () => {
    var string = '<button>submit</button>'
    $('form').append(string);
    // Solution code here...
}
...
const isCapitalized = (str) => {
    var result = [];
    var caps = /\b[A-Z].*?\b/g;
    // result.push(str.match(caps));
    if(str.match(caps)){
        result = str.match(caps);
    }
    return result;
    // Solution code here...
};
...
const citiesAtoJ = (arr) => { // Solution code here...
    var patt = /^[A-J]\S+$/g;
   var result = [];
   for(let i = 0; i<arr.length;i++){
   if(arr[i].match(patt)){
result.push(arr[i].match(patt)[0]);
   }
   }
   return result;
};
...
const matchMonth = (input) => { // Solution code here...
};
...
const noPunctuation = str => { // Solution code here...
};
...
let hangman = (str) => { // Solution code here...
};
...
const findShells = (str) => { // Solution code here...
};
...
describe('Testing challenge 3', () => {
    test('It should only return words that begin with a capital letter', () => {
        ...
        expect(isCapitalized('Given by our hand in the meadow that is called Runnymede, between Windsor and Staines, on the fifteenth day of June in the seventeenth year of our reign (i.e. 1215: the new regnal year began on 28 May).')).toStrictEqual([
            'Given',
            'Runnymede',
            'Windsor',
            'Staines',
...
describe('Testing challenge 6', () => {
    ...
    test('It should only return words that are immediately followed by a space', () => {
        ...
        expect(noPunctuation('Given by our hand in the meadow that is called Runnymede, between Windsor and Staines, on the fifteenth day of June in the seventeenth year of our reign (i.e. 1215: the new regnal year began on 28 May).')).toEqual(expect.arrayContaining([
            'Given ',
            'by ',
            'our ',
            'hand ',
